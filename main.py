...
def main():
    ...
    files, columns = functions.get_files()
    ...
    for grand in columns["Grandeza"]:
        ...
        for t in range(times):
            dir_path = experiment+"/"+grand+"/"+str(t)
            ...
            for i in range(n_hidden):
                hidden_layer = Dense(n_neurons, activation="tanh")(hidden_layer)
        ...
        acc_df.to_csv(experiment+"/accuracy.csv")
        loss_df.to_csv(experiment+"/loss.csv")
